...
alias ....='cd ../..'
alias cls='clear'
alias koszcls='rm -vRI .local/share/Trash/files .local/share/Trash/info; echo -e "\n >> ${red}trash is gone$NC <<\n"'
alias top10='print -l ${(o)history%% *} | uniq -c | sort -nr | head -n 10'
alias ports='lsof -i -n -P'
alias nikto='perl /opt/lampp/htdocs/own/nikto/nikto.pl'
...
alias mojryj="mplayer tv://"
alias telehack="telnet telehack.com"
alias won='echo "bye arpi..."; sleep 2s && sudo shutdown -h now'
alias kurwa='echo "be back right now..."; sleep 2s && sudo shutdown -r now'
#_______________________________________________________/ RADIO


alias radio-trojka="mplayer http://stream.polskieradio.pl/program3|ccze -A"
alias radio-czworka="mplayer -cache 256 mms://stream.polskieradio.pl/program4"
alias radio-lepszypoznan.pl="mplayer -cache 256 http://radio.lepszypoznan.pl:8000/lepszypoznan.aac | ccze -A"z2
alias radio-lepszypoznan.pl-rock="mplayer -cache 256 http://radio.lepszypoznan.pl:8000/rock.aaci | ccze -A"
alias radio-szanty24="mplayer http://stream2.nadaje.com:8016/listen.pls | ccze -A"
alias radio-industrial="mplayer http://radio.realindustrialradio.com:8000 | ccze -A"

#_______________________________________________________/ TELEWIZJA

alias TV_hak5="livestreamer -p mpv filmon.com/tv/hak5-hd-mp4-30fps low"
alias TV_crime="livestreamer -p mpv http://vaughnlive.tv/crimecentral worst"
alias TV_crime2="livestreamer -p mplayer http://veetle.com/v/50bd64fd087cb best"
alias TV_cbs="livestreamer -p mpv http://www.filmon.com/tv/cbs-reality low "
alias TV_cbs1='livestreamer -p mpv https://www.filmon.com/tv/cbs-reality1 low'
########################################################################
## file type ###########################################################
########################################################################
